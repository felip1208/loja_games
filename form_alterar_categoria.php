...
<body>
        <form method="post" action="alterar_categoria.php">
            ...
            <?php //abre linguagem php
                //Fazendo a conexão
                require("connect.php"); //Fazendo a conexão - importando a página connect
                ...
                else
                {
                    ...
                    //Laço de repetição para imprimir a quantidade de categorias cadastradas
